...
export default function Profile() {
  ...
  const handleShare = async () => {
    ...
    if (navigator.share) {
      await navigator.share({ title: "Feedle", url }).catch(() => {});
    } else {
          ...
          {user?.isSeller ? (
            ...
            <div>
              <p style={{ fontFamily: font, fontSize: 13, color: C.mid, margin: "0 0 14px", lineHeight: 1.6 }}>
                Turn your craft into a business. List your handcrafted pieces and reach buyers who love unique, artisan work.
              </p>
              <button
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 4 }}>
            ...
            >
              ...
              <div>
                ...
                <p style={{ fontFamily: font, fontSize: 12, color: C.muted, margin: "2px 0 0" }}>Invite someone to discover handcrafted</p>
              </div>
            </button>
